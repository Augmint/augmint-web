...
export function RepayHelp(props) {
    ...
    return (
        <Message info {...other}>
            <p>You can repay your ACD loan anytime before its maturity. </p>
            ...
            <p>
                ...
                than the ACD loan amount less the fees for the collection then the leftover ETH will be transfered back
