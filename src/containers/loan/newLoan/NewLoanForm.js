                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    >
                        <Label basic>
                            Repayment amount{": "}
                            <ToolTip>
                                Loan <nobr>A-EUR</nobr> amount to be payed back = Disbursed amount x ( 1 / Discount Rate )
                            </ToolTip>
                        </Label>
                        <input />
                        <Label><nobr>A-EUR</nobr></Label>
                    ...
                    >
                        <Label basic>
                            Collateral:{" "}
                            <ToolTip>
                                ETH to be held as collateral = <nobr>A-EUR</nobr> Loan Amount / ETHEUR rate x (1 / Coverage ratio)
