...
export function DiscountRateToolTip(props) {
    return (
        <ToolTip header="Discount Rate">
            Disbursed <nobr>A-EUR</nobr> amount / amount due on maturity.<br />
            E.g. Disbursed loan amount is 100 <nobr>A-EUR</nobr> and discount rate is {props.discountRate * 100}% then<br />
            {Math.round(10000 / props.discountRate) / 100} <nobr>A-EUR</nobr> will be repayable.
        </ToolTip>
    );
}
...
export function LoanCollateralRatioToolTip(props) {
    return (
        <ToolTip header="Loan/collateral ratio">
            <nobr>A-EUR</nobr> loan amount / EUR value of ETH collateral.<br />
            I.e. How much <nobr>A-EUR</nobr> loan can you get for your ETH<br />
            ...
            <nobr>A-EUR</nobr> for 1 ETH placed in escrow.
        </ToolTip>
    );
}
...
export function DefaultingFeeTooltip(props) {
    return (
        <ToolTip header="Defaulting fee">
            ...
            your <nobr>A-EUR</nobr> repayment due. It will use the ETH/EUR rates at moment of the collection executed.<br />
            ...
            <small>
                ...
                You don't repay 200 <nobr>A-EUR</nobr> with 2 ETH in escrow.<br />
                To cover you missed repayment 1 ETH + 0.05ETH (5% of 200 <nobr>A-EUR</nobr>) is required.<br />
