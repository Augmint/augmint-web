...
export function DcmOverview(props) {
    return (
        <Tsegment>
            ...
            <Tblock header="Why?">
                <p>
                    Cryptocurrencies are amazing for storing and transferring
                    digital value in a decentralised way.
                </p>
                <p>
                    Their limited supply makes them a potential investment
                    target but it also makes them less compelling to use for
                    ordinary payments.{" "}
                </p>
                <p>
                    Would you spend your Bitcoins to buy a laptop if you
                    strongly believe the BTC price will go up? <br />Would you
                    agree to get your salary in a fixed Ethereum amount if you
                    are unsure of the future price of ETH?
                </p>
            </Tblock>
