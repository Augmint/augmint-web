        ...
        <Segment basic as="section" className="green-gradient">
            <Tsegment header="How it works" id={"how-it-works"}>
                <Tblock header="Price stability">
                    <p>
                        There are multiple mechanisms to ensure the market expectation and the actual price is around
                        parity to the pegged currency.
                    </p>
                    <Tblock.SubHeader header="Market mechanics" />
                    <p>
                        The primary foundation of stability is the continuous supply of Augmint tokens via loan
                        originations and a corresponding demand for paying back loans on maturity.
                    </p>
                    <p>
                        Further specific features of the Augmint system will work towards maintaining stability by
                        smoothing the demand & supply peaks and troughs.
                    </p>
                    ...
                    <p>
                        Augmint can intervene from its reserves accumulated from fees, defaults and interests. Augmint
                        reserves can be used on held only for market intervention.
                    </p>
                    <p>
                        Check out our{" "}
            ...
            <Tsegment header="Governance" id={"governance"}>
                <Tblock>
                    ...
                    <p>
                        We aim to handle as many "decisions" as possible with smart contracts but it's not feasible to
                        prepare for every case with automated smart contracts, such as financial parameters, trusted
                        price oracles, new digital assets, contract releases.
                    </p>
                    <p>
                        These decisions are made by stakeholders - governance token (GDC) holders. Augmint's governance
