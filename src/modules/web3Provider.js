...
export const connectWeb3 = () => {
    ...
    console.log(disclaimerAccepted, "disc");
    console.log(documentLoaded, "doc");
    console.log(!web3Connect.isConnected, "connected");
    console.log(!web3Connect.isLoading, "isloading");
